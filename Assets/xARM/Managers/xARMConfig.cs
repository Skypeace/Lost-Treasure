...
public class xARMConfig {
	...
	private bool foldoutWinRT = false;
	...
	// Global
	private bool hideGameView = false;
	...
	public bool FoldoutWinRT {
		get {
			return foldoutWinRT;
		}
		set {
			MarkConfigAsChanged (foldoutWinRT, value);
	...
	public bool IntegrationUGUIPhySize {
		get {
			return integrationUGUIPhySize;
		}
		set {
			MarkConfigAsChanged (integrationUGUIPhySize, value);

			integrationUGUIPhySize = value;
		}
	}

	public bool IntegrationUGUIPhySizeKeepDPI {
		get {
			return integrationUGUIPhySizeKeepDPI;
		}
		set {
			MarkConfigAsChanged (integrationUGUIPhySizeKeepDPI, value);

			integrationUGUIPhySizeKeepDPI = value;
		}
	}
	...
	public Vector2 HiddenGameViewPosition {
		get {
			return hiddenGameViewPosition;
		}
		set {
			MarkConfigAsChanged (hiddenGameViewPosition, value);
			
			hiddenGameViewPosition = value;
		}
	}
	...
	#region Global
	public bool HideGameView {
		get {
			return hideGameView;
		}
		set {
			MarkConfigAsChanged (hideGameView, value);
	...
	private void save() {
		...
		if(Version == "") Version = xARMVersion;
	...
	private static xARMConfig load() {
		...
		// detect new version
		if(loadedxARMConfig.Version != xARMVersion){

			// reopen Contact foldout
			loadedxARMConfig.FoldoutContact = true;

			// set new version (and mark as chaged)
			loadedxARMConfig.Version = xARMVersion;
		}
