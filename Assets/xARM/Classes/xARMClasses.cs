...
namespace xARM{
	...
	public enum xARMScreenCapGroup {iOS=0, Android, WinPhone8, WindowsRT, Standalone=10, Custom}; // for backward compatibility: WindowsRT instead of more precise WinRT
